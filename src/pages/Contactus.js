    ...
    <div className="w-full max-h-full bg-[#f8f9fd]">
      ...
      <main>
        ...
        <section className='w-full min-h-[100vh] flex justify-center items-center'>
          <div className="w-[90%] h-[30em] bg-red-400 grid grid-cols-2">
            <div>
             ...
             <div className="w-full flex flex-col justify-between items-center">
                <div className="w-[85%] h-20 bg-[#6d9b9c] drop-shadow flex items-center rounded-md shadow-lg p-10 m-2">
                    ...
                    <div className="text-white">
                      <span className="pl-6 font-semibold text-[1rem]">Address: </span><span>198 Brown Road,Lagos, Nigeria,23401</span>
                    </div>
                </div>
                <div className="w-[85%] h-20 bg-[#6d9b9c] flex items-center p-10 m-2 rounded-md ">
                    <div className="w-10 h-10 flex justify-center items-center border-2 border-white rounded-full">
                        <FaPhoneAlt className="text-2xl text-white"/>
                    </div>
                    <div className="text-white">
                      <span className="pl-6 font-semibold text-[1rem]">Phones: </span><span>+234-08043528292</span>
                    </div>
                </div>
                 ...
                 <div className="w-[85%] h-20 bg-[#6d9b9c] flex items-center p-10 m-2 rounded-md ">
                    ...
                    <div className="text-white">
                      <span className="pl-6 font-semibold text-[1rem]">Email: </span><span>info@abrydservices.com</span>
                    </div>
                </div>
                <div className="w-[85%] h-20 bg-[#6d9b9c] flex items-center p-10 rounded-md ">
                    <div className="w-10 h-10 flex justify-center items-center border-2 border-white rounded-full">
                        <BiWorld className="text-2xl text-white"/>
                    </div>
                    <div className="text-white">
                      <span className="pl-6 font-semibold text-[1rem]">Website: </span><span>www.abrydservices.com</span>
                    </div>
                </div>
             </div>
             </div>
